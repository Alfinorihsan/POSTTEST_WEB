        ...
        <div id="bagian-atas">
            <div class="row">
                <div class="col col-12">
                    <h1 style="margin-left: 10%;">Hasil Pesanan</h1>
                    <form action="pesanan.php" action="POST" style="margin-left: 10%;">
                        <div class="form-control">
                            <label for="">Nama</label>
                            <p style="margin: 0px!important"><?= $_POST['name']  ?></p>
                        </div>
                        <div class="form-control">
                            <label for="">Jenis Pakaian</label>
                            <p style="margin: 0px!important"><?= $_POST['cloth']  ?></p>
                        </div>
                        <div class="form-control">
                            <label for="">Total</label>
                            <p style="margin: 0px!important"><?= $_POST['total']  ?></p>
                        </div>
                        <div class="form-control">
                            <label for="">Tanggal Pengambilan</label>
                            <p style="margin: 0px!important"><?= $_POST['date']  ?></p>
                        </div>
                    </form>
                </div>
            </div>
