<?php
  ...
  if(isset($_POST['nama'])) {
    ...
    if($_POST['password'] != $_POST['password_confirmation']) {
      ...
      $checkEmail = query("SELECT * FROM users WHERE no_hp='{$_POST['no_hp']}'");
      if(!empty($checkEmail)) {
        echo '<script type="text/javascript">alert("No. HP sudah terdaftar!");</script>';
      } else {
        store("pelanggan", [
          "nama" => $_POST["nama"],
          "no_hp" => $_POST["no_hp"],
        ...
        <div id="bagian-atas" style="min-height: 80vh;">
            <div class="row">
                <div class="col col-12">
                    <h1 style="margin-left: 10%;">Register</h1>
