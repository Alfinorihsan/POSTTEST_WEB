...
if (isset($_POST['nama'])) {
    ...
    if ($_FILES['bukti_pembayaran']['name'] != '') {
        ...
        $filename = uniqid();
        $filename .= '.';
        $filename .= $ekstensiGambar;
        move_uploaded_file($tmpName, "./bukti-pembayaran/$filename");
        // * DELETE OLD FILE
        ...
        <div id="bagian-atas" style="min-height: 80vh;">
            <div class="row">
                <div class="col col-12">
                    ...
                    <p style="margin-left: 10%;">* Tidak perlu upload apabila tidak diubah file bukti pembayaran</p>
